            ...
            <table width="519">
                <tr>
                    <td class="c" colspan="4">
                        <a href="game.php?page=renameplanet" title="{$Planet_menu}">{$Planet} "{$planet_name}"</a> ({$user_username})
                    </td>
		</tr>
		{$Have_new_message}
			...
			<th colspan="3">
				...
				<tbody>
					...
					<td colspan="2" align="center" width="100%" style="background-color: transparent;">
                                            <b>({$Rank} <a href="stat.php?range={$u_user_rank}">{$user_rank}</a> {$of} {$max_users})</b>
					</td>
                                    </tr>
				</tbody>
                            </table>
